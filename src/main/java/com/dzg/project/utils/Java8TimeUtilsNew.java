 ...
 */
public class Java8TimeUtilsNew {
  ...
  public static String getNowDate_Ye() {
    return LocalDateTime.now().plusDays(-1).format(yyyyMMdd_EN);
  }

  public static String getNowDate_To() {
    return LocalDateTime.now().plusDays(1).format(yyyyMMdd_EN);
  }
   ...
   * 计算两个时间戳之间差多少天
   */
  public static int peridCount(String date1s, String date2s) {
    return peridCount(Long.valueOf(date1s), Long.valueOf(date2s));
  }

  public static void main(String[] args) {
    System.out.println(peridCount("1568651365167", "1568817981000"));
  }

  public static int peridCount(Long date1, Long date2) {
    return Period.between(LocalDate.parse(convertTimeToString(date1), yyyyMMdd_EN),
            LocalDate.parse(convertTimeToString(date2), yyyyMMdd_EN)).getDays();
  }
  ...
  public static String convertTimeToString(Long time) {
    return yyyyMMdd_EN.format(LocalDateTime.ofInstant(Instant.ofEpochMilli(time), ZoneId.of("GMT")));
  }
  ...
  public static String convertTimeToString(String time) {
    return yyyyMMdd_EN.format(LocalDateTime.ofInstant(Instant.ofEpochMilli(Long.valueOf(time)), ZoneId.of("GMT")));
  }
  ...
  public static Long convertTimeToLong(String time) {
    LocalDateTime parse = LocalDateTime.parse(time, yyyyMMddHHmmss_EN);
